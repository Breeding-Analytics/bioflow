                           ...
                           tabPanel( div(icon("book"), "Information-OCS") ,
                                     ...
                                     shinydashboard::box(status="success",width = 12,
                                                         ...
                                                         column(width=12,   style = "height:580px; overflow-y: scroll;overflow-x: scroll;",
                                                                column(width = 6,
                                                                       h1(strong(span("Optimal Cross Selection", tags$a(href="https://www.youtube.com/channel/UCikAyaDKdC5LAtcbVePWgIg", icon("youtube") , target="_blank"), style="color:green"))),
                                                                       h2(strong("Status:")),
