                           ...
                           tabPanel(div(icon("arrow-right-to-bracket"), "Input"),
                                    tabsetPanel(
                                      ...
                                      tabPanel("Select traits", icon = icon("dice-two"),
                                               ...
                                               column(width=12, style = "background-color:grey; color: #FFFFFF",
                                                      ...
                                                      column(width = 8, style = "background-color:grey; color: #FFFFFF",
                                                             br(),
                                                             shinydashboard::box(width = 12, status = "success", solidHeader=FALSE,collapsible = TRUE, collapsed = TRUE, title = "Alternative response distributions to fit...",
                                      ...
                                      tabPanel("Pick the model", icon = icon("dice-three"),
                                               ...
                                               column(width=12, style = "background-color:grey; color: #FFFFFF",
                                                      shinydashboard::box(width = 12, status = "success",solidHeader=FALSE,collapsible = TRUE, collapsed = TRUE, title = "Additional model settings...",
                                      ...
                                      tabPanel("Specify GxE", icon = icon("dice-four"),
                                               ...
                                               column(width=12,style = "background-color:grey; color: #FFFFFF",
                                                      ...
                                                      column(width=12,
                                                             shinydashboard::box(width = 12, status = "success", solidHeader=FALSE,collapsible = TRUE, collapsed = TRUE, title = "Fields to exclude (Optional)...",
