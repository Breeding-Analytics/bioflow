...
mod_qaGenoApp_ui <- function(id){
  ...
  tagList(
    ...
    shiny::sidebarPanel(#width = 3,
      ...
      numericInput(ns("propNaUpperThreshForMarker"), label = "Threshold for missing data in markers (> will be removed)", value = .3, step = .05, max = 1, min = 0),
      numericInput(ns("propNaUpperThreshForInds"), label = "Threshold for missing data in individuals(> will be removed)", value = .3, step = .05, max = 1, min = 0),
      numericInput(ns("maf"), label = "Minor allele frequency (< will be removed)", value = 0, step = .05, max = 1, min = 0),
      numericInput(ns("propHetUpperThreshForMarker"), label = "Threshold for heterozygosity in markers (> will be removed)", value = 1, step = .05, max = 1, min = 0),
      numericInput(ns("propFisUpperThreshForMarker"), label = "Threshold for inbreeding in markers (> will be removed)", value = 1, step = .05, max = 1, min = 0),
      hr(style = "border-top: 1px solid #4c4c4c;"),
