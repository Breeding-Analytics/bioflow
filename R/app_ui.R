  ...
  div(
    ...
    navbarPage(
      ...
      navbarMenu("Gene flow and Drift", icon = icon("wind"),
                 ...
                 tabPanel(div(icon("circle-nodes"), "Population structure (", icon("dna"), icon("seedling"), ")"), mod_PopStrApp_ui("mod_PopStrApp_1") ), #  icon = icon("diagram-project")), # may include PCA based, structure based, clustering
