                           ...
                           tabPanel(div(icon("arrow-right-from-bracket"), "Output tabs" ) , value = "outputTabs",
                                    tabsetPanel(
                                      tabPanel("Dashboard", icon = icon("file-image"),
                                               ...
                                               br(),
                                               actionButton(ns("renderReportReport"), "Download dashboard", icon = icon("download")),
                                               downloadButton(ns("downloadReportReport"), "Download dashboard", style = "visibility:hidden;"),
                                               br(),
