  ...
  moduleServer( id, function(input, output, session){
    ...
    observeEvent(c(data()), {
      ...
      if(!is.null(data()$status)){
        ...
        names(traitsBuilder) <- cgiarBase::replaceValues(Source = traitsBuilder, Search = c("qaRaw","qaGeno","sta","mta","mtaFlex","mtaLmms","mtaAsr","indexD","ocs","gpcp","rgg","pgg","oft","neMarker","gVerif","mas","abiDash","PopStrM", "qaConsistency") , Replace = c("QA phenotypes (qaRaw)", "QA genotypes (qaGeno)", "Single Trial Analysis (sta)", "Multi Trial Analysis (mta)", "Multi Trial Analysis (mtaFlex)","Multi Trial Analysis (mtaLmms)", "Multi Trial Analysis (mtaAsreml)", "Selection Index (indexD)", "Optimal Cross Selection (ocs)", "Genomic Prediction of Cross Peformance (gpcp)","Realized Genetic Gain (rgg)", "Predicted Genetic Gain (pgg)", "On Farm Trial (oft)", "Number of Founders (ne)", "Genotype verification (gVerif)","Marker assisted selection (mas)", "ABI dashboard (abiDash)", "Population Structure (PopStrM)", "Data Consistency (qaConsistency)") )
    ...
    outReport <- eventReactive(input$runReport, {
      ...
      markdownType <- cgiarBase::replaceValues(Source = input$module, Search = c("qaRaw","qaGeno","sta","mta","mtaFlex","mtaLmms","mtaAsr","indexD","ocs","gpcp","rgg","pgg","oft","neMarker","gVerif","mas","abiDash","PopStrM","qaConsistency" ) , Replace = c("reportQaPheno.Rmd","reportQaGeno.Rmd","reportSta.Rmd","reportMta.Rmd","reportMtaFlex.Rmd","reportMtaLMMsolver.Rmd","reportMtaASREML.Rmd","reportIndex.Rmd","reportOcs.Rmd","reportGpcp.Rmd","reportRgg.Rmd","reportPgg.Rmd", "reportOft.Rmd", "reportNeGeno.Rmd", "reportVerifGeno.Rmd","reportMas.Rmd","reportAbi.Rmd","reportPopStr.Rmd","reportQaPheno.Rmd") )
      resultType <- cgiarBase::replaceValues(Source = input$module, Search = c("qaRaw","qaGeno","sta","mta","mtaFlex","mtaLmms","mtaAsr","indexD","ocs","gpcp","rgg","pgg","oft","neMarker","gVerif","mas","abiDash","PopStrM","qaConsistency" ) , Replace = c("resultQaPheno.RData","resultQaGeno.RData","resultSta.RData","resultMta.RData", "resultMtaFlex.RData","resultMtaLMMsolver.RData","resultMtaASREML.RData","resultIndex.RData","resultOcs.RData","resultGpcp.RData","resultRgg.RData","resultPgg.RData","resultOft.RData", "resultNeGeno.RData", "resultVerifGeno.RData", "resultMas.RData","resultAbi.RData","resultPopStr.RData","reportQaConsistency.RData") )
      ## end
