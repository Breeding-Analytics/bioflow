mod_customcustomqaGenoApp_ui <- function(id) {
  ns <- NS(id)
...
mod_customcustomqaGenoApp_server <- function(id, data) {
  moduleServer(id, function(input, output, session) {
    ...
    observeEvent(input$runQaMb,{
      ...
      if(!is.null(results$modifications$geno)){
        results$modifications$geno <- rbind(result$modifications$geno, new_modifications)
      }else{
        results$modifications$geno = new_modifications}
