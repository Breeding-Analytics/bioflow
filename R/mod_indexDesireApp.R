    ...
    mainPanel( width = 12,
               tabsetPanel( id=ns("tabsMain"),
                            ...
                            tabPanel(div(icon("book"), "Information-Index") ,
                                     br(),
                                     column(width = 6,
                                            h1(strong(span("Desire Selection Index", tags$a(href="https://www.youtube.com/watch?v=YhveKqd0q4s&list=PLZ0lafzH_UmclOPifjCntlMzysEB2_2wX&index=8", icon("youtube") , target="_blank"), style="color:darkcyan"))),
