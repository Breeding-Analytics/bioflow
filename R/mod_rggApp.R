                            ...
                            tabPanel(div(icon("arrow-right-from-bracket"), "Output tabs" ) , value = "outputTabs",
                                     tabsetPanel(
                                       tabPanel("Dashboard", icon = icon("file-image"),
                                                ...
                                                br(),
                                                actionButton(ns("renderReportRgg"), "Download dashboard", icon = icon("download")),
                                                downloadButton(ns("downloadReportRgg"), "Download dashboard", style = "visibility:hidden;"),
                                                br(),
...
mod_rggApp_server <- function(id, data){
  moduleServer( id, function(input, output, session){
    ...
    observeEvent(input$renderReportRgg,{
      ...
      shinyjs::click("downloadReportRgg")
    })
