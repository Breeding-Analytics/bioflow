        ...
        shinydashboard::box(width = 12, status = "success", collapsible = FALSE,
                            ...
                            column(width = 12,
                                   ...
                                   shinydashboard::box(status="success", width = 12,
                                                       ...
                                                       p(strong("IRRI: "),"Alaine Guilles (a.gulles@cgiar.org), Justine Bonifacio (j.bonifacio@cgiar.org), Daniel Pisano(d.pisano@cgiar.org), Leilani Nora (l.nora@cgiar.org)"),
