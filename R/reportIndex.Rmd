...
```{r GY_heatmap, results = "asis", fig.height = 7}

knitr::asis_output(paste0("### Boxplots {.tabset .tabset-pills}    \n\n  "))
# l <- htmltools::tagList()
for(i in 1:3){
  p <- ggplot2::ggplot(mtcars, ggplot2::aes(x=wt, y=mpg)) + ggplot2::geom_point()
  # p$labels$fill <- as.character(i)
  print(htmltools::tagList(plotly::ggplotly(p, tooltip = "text")))
  cat("\n\n  ")
  # l[[i]] <- plotly::ggplotly( ggplot2::ggplot(mtcars, ggplot2::aes(x=wt, y=mpg)) + ggplot2::geom_point() , tooltip = "text")
}
# l
# htmltools::tagList()
```
