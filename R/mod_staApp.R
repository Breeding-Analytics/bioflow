                           ...
                           tabPanel(div(icon("arrow-right-to-bracket"), "Input"),
                                    tabsetPanel(
                                      tabPanel("Pick QA-stamp(s)", icon = icon("table"),
                                               br(),
                                               column(width=12, selectInput(ns("version2Sta"), "Data QA version(s) to consider (records QA-tagged will be ignored)", choices = NULL, multiple = TRUE), style = "background-color:grey; color: #FFFFFF"),
                                               column(width=12,
                                      ...
                                      tabPanel("Pick effect(s)", icon = icon("table"),
                                               br(),
                                               column(width=12, style = "background-color:grey; color: #FFFFFF" ,
                                                      column(width=6, selectInput(ns("genoUnitSta"), "Genetic evaluation unit(s) (required)", choices = NULL, multiple = TRUE) ),
