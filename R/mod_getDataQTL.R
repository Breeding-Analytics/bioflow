                  ...
                  tabPanel(div("1. Load your data" ),
                           ...
                           column(width=4,
                                  tags$div(id = ns('qtl_table_options'),
                                           shinydashboard::box(width=12, title = span(icon('screwdriver-wrench'), ' Options'), collapsible = TRUE, collapsed = TRUE,
                                                               status = 'success', solidHeader = FALSE, style = "color: #000000",
                           ...
                           shinydashboard::box(width = 12,  status = 'success', solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
                                               title = "Preview of uploaded data (click on the '+' symbol to view)",
