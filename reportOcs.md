...
NULL
The trait used for OCS was:  Plant_Height_cm_QTL<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="ocsApp_1-outc6783e4d56f7e8b3" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="ocsApp_1-environ" class="shiny-input-select" multiple="multiple"><option value="Plant_Height_cm_QTL ~ 20 crosses * 30 degrees" selected>Plant_Height_cm_QTL ~ 20 crosses * 30 degrees</option></select>
<script type="application/json" data-for="ocsApp_1-environ">{"plugins":["selectize-plugin-a11y"]}</script>
</div>
</div><!--/html_preserve-->

<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="ocsApp_1-out79bf8aa6eb901659" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="ocsApp_1-outde2b2ffcc615f99b" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="ocsApp_1-outeac978f7067e9420" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="ocsApp_1-traitFilterPredictions2D2" class="shiny-input-select" multiple="multiple"><option value="Plant_Height_cm_QTL" selected>Plant_Height_cm_QTL</option>
<option value="Yield_Mg_ha_QTL" selected>Yield_Mg_ha_QTL</option></select>
<script type="application/json" data-for="ocsApp_1-traitFilterPredictions2D2">{"plugins":["selectize-plugin-a11y"]}</script>
</div>
</div><!--/html_preserve-->

<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="ocsApp_1-outf08e701bbef8c246" style="width:100%;height:400px;"></div><!--/html_preserve-->
