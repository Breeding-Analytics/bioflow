...
<div>
<select id="qaPhenoApp_1-traitQa" class="shiny-input-select"><option value="GYKGPHA" selected>GYKGPHA</option>
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="qaPhenoApp_1-out8b7b154649a00899" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="qaPhenoApp_1-traitQaBox" class="shiny-input-select"><option value="GYKGPHA" selected>GYKGPHA</option>
<option value="DTF">DTF</option>
<option value="PH">PH</option></select>
...
<!--html_preserve--><div class="shiny-plot-output html-fill-item" id="qaPhenoApp_1-outa6b531299460ee49" style="width:100%;height:400px;"></div><!--/html_preserve-->
