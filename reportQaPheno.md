...
<div>
<select id="qaRawApp_1-traitQa" class="shiny-input-select"><option value="Silk_DAP_days" selected>Silk_DAP_days</option></select>
<script type="application/json" data-for="qaRawApp_1-traitQa" data-nonempty="">{"plugins":["selectize-plugin-a11y"]}</script>
</div>
</div><!--/html_preserve-->


<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="qaRawApp_1-outcf1dcde2d5f6027b" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="qaRawApp_1-traitQaBox" class="shiny-input-select"><option value="Silk_DAP_days" selected>Silk_DAP_days</option></select>
<script type="application/json" data-for="qaRawApp_1-traitQaBox" data-nonempty="">{"plugins":["selectize-plugin-a11y"]}</script>
</div>
</div><!--/html_preserve-->

<!--html_preserve--><div class="shiny-plot-output html-fill-item" id="qaRawApp_1-outa8c8dbc16fbeba8c" style="width:100%;height:400px;"></div><!--/html_preserve-->
