...
<div>
<select id="reportBuilder_1-traitQa" class="shiny-input-select"><option value="shtwt" selected>shtwt</option>
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="reportBuilder_1-out7b989cf3efd6e7f9" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="reportBuilder_1-traitQaBox" class="shiny-input-select"><option value="shtwt" selected>shtwt</option>
<option value="rtwt">rtwt</option></select>
<script type="application/json" data-for="reportBuilder_1-traitQaBox" data-nonempty="">{"plugins":["selectize-plugin-a11y"]}</script>
</div>
</div><!--/html_preserve-->

<!--html_preserve--><div class="shiny-plot-output html-fill-item" id="reportBuilder_1-outb63372cf1f3bc262" style="width:100%;height:400px;"></div><!--/html_preserve-->
