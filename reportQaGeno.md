...
<label class="control-label" id="reportBuilder_1-traitQa-label" for="reportBuilder_1-traitQa">Reason for QA:</label>
<div>
<select id="reportBuilder_1-traitQa" class="shiny-input-select"><option value="%missing" selected>%missing</option>
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="reportBuilder_1-out88faebee1fe2194e" style="width:100%;height:auto;"></div><!--/html_preserve-->
