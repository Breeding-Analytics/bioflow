...
The data strucure from bioflow and expected columns can be understood by running the function cgiarBase::create_getData_object()

2) Functions should not be written inside the interface. The functions should be stored in the cgiarBase, cgiarGenomics or cgiarPipeline packages.
