...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="reportBuilder_1-outd958154f4ce87d06" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="reportBuilder_1-traitMta" class="shiny-input-select"><option value="shtwt" selected>shtwt</option>
...
<!--html_preserve--><div class="shiny-plot-output html-fill-item" id="reportBuilder_1-outfcc9b1598b531467" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div>
<select id="reportBuilder_1-traitMtaConnect" class="shiny-input-select"><option value="shtwt" selected>shtwt</option>
<option value="rtwt">rtwt</option></select>
<script type="application/json" data-for="reportBuilder_1-traitMtaConnect" data-nonempty="">{"plugins":["selectize-plugin-a11y"]}</script>
</div>
</div><!--/html_preserve-->

<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="reportBuilder_1-outac8a92240f4b1814" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div>
<select id="reportBuilder_1-traitPredictionsCorrelation" class="shiny-input-select"><option value="shtwt" selected>shtwt</option>
<option value="rtwt">rtwt</option></select>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="reportBuilder_1-out7270c173b0148078" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="shiny-plot-output html-fill-item" id="reportBuilder_1-out9d61e72747fe64de" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="shiny-plot-output html-fill-item" id="reportBuilder_1-out92e7a741ffd43cc4" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div>
<select id="reportBuilder_1-traitMta2" class="shiny-input-select"><option value="shtwt" selected>shtwt</option>
<option value="rtwt">rtwt</option></select>
<script type="application/json" data-for="reportBuilder_1-traitMta2" data-nonempty="">{"plugins":["selectize-plugin-a11y"]}</script>
</div>
</div><!--/html_preserve-->

<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="reportBuilder_1-outbfdc332152797b9d" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="shiny-plot-output html-fill-item" id="reportBuilder_1-out303e484891106bcc" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="reportBuilder_1-out090f29229626d80b" style="width:100%;height:auto;"></div><!--/html_preserve-->
