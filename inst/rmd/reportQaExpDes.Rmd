---
title: "Quality Assurance Experimental Design Report"
...
suppressWarnings(tryCatch({
  if(file.exists("./outputs/result.RData")){
    load("./outputs/resultQaExpDes.RData")
  }else{
    load("resultQaExpDes.RData")
  }
}, error = function(e) {
  shinyjs::hide()
}))
...
if (is.null(result)){
  ...
  idQa <- result$status[which(result$status$module %in% c("qaExpDesign")),"analysisId"];
...
if (is.null(result)){
  ...
  if("params" %in% ls()){ # we will download the document
    ...
    DT::renderDT(printTable(modifications,
