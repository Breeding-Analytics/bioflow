...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="mtaLMMsolveApp_1-outfb093f3e5024519b" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<div>
<select id="mtaLMMsolveApp_1-boxplotMtaPredsTrait" class="shiny-input-select"><option value="GY_MOI15_5_CMP_THA" selected>GY_MOI15_5_CMP_THA</option></select>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="mtaLMMsolveApp_1-outc466aaca67ff29e4" style="width:100%;height:400px;"></div><!--/html_preserve-->
</div>
...
<div>
<select id="mtaLMMsolveApp_1-traitMtaConnect" class="shiny-input-select"><option value="GY_MOI15_5_CMP_THA" selected>GY_MOI15_5_CMP_THA</option></select>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="mtaLMMsolveApp_1-outbad8d19022f05a36" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div>
<select id="mtaLMMsolveApp_1-traitPredictionsCorrelation" class="shiny-input-select"><option value="GY_MOI15_5_CMP_THA" selected>GY_MOI15_5_CMP_THA</option></select>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="mtaLMMsolveApp_1-out10d702220752f268" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div>
<select id="mtaLMMsolveApp_1-traitBiplot" class="shiny-input-select"><option value="GY_MOI15_5_CMP_THA" selected>GY_MOI15_5_CMP_THA</option></select>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="mtaLMMsolveApp_1-outd13a86e1d1f49b8c" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div>
<select id="mtaLMMsolveApp_1-scatterMtaPredsTrait" class="shiny-input-select"><option value="GY_MOI15_5_CMP_THA" selected>GY_MOI15_5_CMP_THA</option></select>
...
<option value="environment">environment</option></select>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="mtaLMMsolveApp_1-out3905aef4906cace0" style="width:100%;height:400px;"></div><!--/html_preserve-->
...
<div>
<select id="mtaLMMsolveApp_1-checkMta" class="shiny-input-select"><option value="CLBLS20W014&amp;CML549" selected>CLBLS20W014&amp;CML549</option>
...
<div>
<select id="mtaLMMsolveApp_1-checkMtaTrait" class="shiny-input-select"><option value="GY_MOI15_5_CMP_THA" selected>GY_MOI15_5_CMP_THA</option></select>
...
<!--html_preserve--><div class="plotly html-widget html-widget-output shiny-report-size shiny-report-theme html-fill-item" id="mtaLMMsolveApp_1-out47126592e3fffb91" style="width:100%;height:400px;"></div><!--/html_preserve-->
</div>

<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="mtaLMMsolveApp_1-outcceba10d5f2edd19" style="width:100%;height:auto;"></div><!--/html_preserve-->
...
<!--html_preserve--><div class="datatables html-widget html-widget-output shiny-report-size html-fill-item" id="mtaLMMsolveApp_1-out2f99b06fd9099c7e" style="width:100%;height:auto;"></div><!--/html_preserve-->
