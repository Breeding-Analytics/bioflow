...
if (is.null(result)){
  ...
  if("params" %in% ls()){ # we will download the document
    ...
    for (j in 1:length(traits)){
      ...
      myLabel <- paste0("Y = ", round(as.numeric(myMetrics[myMetrics$parameter == "ggInter","value"]),4), " + ",
                        round(as.numeric(myMetrics[myMetrics$parameter == "ggSlope","value"]),4), " x Year, ", 
                        round(as.numeric(myMetrics[myMetrics$parameter == "gg%(average.year)","value"]),2),"% Gain")
