...
6. Individual sensitivity values from the Finlay-Wilkinson model (Finlay & Wilkinson, 1963) (output)
...
if (is.null(result)){
  ...
  if("params" %in% ls()){ # we will download the document
    ...
    for(iTrait in traits){
      ...
      # combine plots
      print(htmltools::tagList( plotly::subplot(plotly::ggplotly(p), plotly::ggplotly(p2), nrows=1) ) )
      # print(p) # static
    ...
    plotly::renderPlotly({ # dynamic
      ...
      plotly::subplot(ply1, ply2, nrows=1)
...
if (is.null(result)){
  ...
  if("params" %in% ls()){ # we will download the document
    ...
    for(iTrait in traits){
      ...
      print(htmltools::tagList( plotly::subplot(plotly::ggplotly(p2), plotly::ggplotly(p1), nrows=1, widths = c(0.75,0.25) ) ) )
    ...
    plotly::renderPlotly({
      ...
      ply2 <- plotly::ggplotly(p2)
      plotly::subplot(ply2, ply1, nrows=1, widths = c(0.75,0.25))
